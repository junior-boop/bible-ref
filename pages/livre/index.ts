...
const data = [
    ...
    {
        titre: "1 Samuel",
        abr: ["1SAM", "1Sam", "1sam", "1 SAM", "1 Sam", "1 sam", "1SM", "1Sm", "1sm", "1 SM", "1 Sm", "1 sm", "1S", "1s"],
        index: "A9",
        nbr_chap: 31,
        livre : Sam1
    },
    {
        titre: "2 Samuel",
        abr: ["2SAM", "2Sam", "2sam", "2 SAM", "2 Sam", "2 sam", "2SM", "2Sm", "2sm", "2 SM", "2 Sm", "2 sm", "2S", "2s"],
        index: "A10",
        nbr_chap: 24,
        livre : Sam2
    },
    {
        titre: "1 Rois",
        abr: ["1RS", "1Rs", "1rs", "1 Rs", "1 RS", "1 rs", "1R", "1r", "1 R", "1 r"],
        index: "A11",
        nbr_chap: 22,
        livre : Rois1
    },
    {
        titre: "2 Rois",
        abr: ["2RS", "2Rs", "2rs", "2 Rs", "2 RS", "2 rs", "2R", "2r", "2 R", "2 r"],
        index: "A12",
        nbr_chap: 25,
        livre : Rois2
    },
    ...
    {
        titre: "Esaïe",
        abr: ["ES", "Es", "es", "Essaie", "ESSAIE", "essaie", "Ess","ESS", "ess", "Esaie", "esaie", "ESAIE", "Esa", "ESA", "esa", "Esai", 'esai', 'ESAI'],
        index: "A23",
        nbr_chap: 66,
        livre : Essaie
    },
    ...
    {
        titre: "Daniel",
        abr: ["DAN", "Dan", "dan", "Daniel", 'daniel', 'DANIEL', 'dani', "Dani", "DANI"],
        index: "A27",
        nbr_chap: 12,
        livre : Dan
    },
    ...
    {
        titre: "Aggée",
        abr: ["AGG", "Agg","agg","Aggee", "AGGEE", "Agge", "agge", "Aggée", "aggée", "AGGÉE"],
        index: "A37",
        nbr_chap: 2,
        livre : Agge
    },
    {
        titre: "Zacharie",
        abr: ["ZACH", "Zach", "zach", "ZAC", "Zac", "zac", "ZACHARIE", "Zacharie", "zacharie"],
        index: "A38",
        nbr_chap: 14,
        livre : Zach
    },
    ...
    {
        titre: "Matthieu",
        abr: ["MAT", "Mat", "mat", "MTT", "Mtt", "mtt", "matthieu", "Matthieu", "MATTHIEU", "Mathieu", "mathieu", "MATHIEU","MATT","Matt","matt", "Math", "math", "MATH"],
        index: "N1",
        nbr_chap: 28,
        livre : Matt
    },
    ...
    {
        titre: "1 Corinthiens",
        abr: ["1COR", "1Cor", "1cor", "1COR", "1Cor", "1cor", '1corinthiens', '1Corinthiens', '1CORINTHIENS'],
        index: "N7",
        nbr_chap: 16,
        livre : Cor1
    },
...
export default function filtre ({ livre, chap, vers1, vers2 }: filter){
    ...
    let verset2 = vers2 !== undefined ? parseInt(vers2) : null
    ...
    for(let i = 0 ; i < data.length; i++){
        ...
        for (let t = 0; t < abr.length; t++){
            if(book === abr[t]){
                let CC = data[i].livre
                let chapter = CC[chapt - 1].chapitre
                if(verset2 !== null){
                    let arr = []
                    for(let v = verset1-1; v < verset2; v++ ){
                        let z = CC[chapt - 1].contenu[v]
                        arr.push(z)
                    }
                    let versChar = verset1+"-"+verset2
                    let reference = chapter+": "+versChar
                    let result = {chapitre : chapter, vers : arr, versChar, reference  }
                    return result
                } else {
                    let ref = CC[chapt - 1].contenu[verset1 - 1]
                    let versChar = verset1
                    let reference = chapter+": "+versChar
                    let result = {chapitre : chapter, vers : [ref], versChar, reference}
                    return result
                }
            }
        }
